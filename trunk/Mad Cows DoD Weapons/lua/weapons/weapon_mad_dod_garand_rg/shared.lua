...
SWEP.ViewModel			= "models/weapons/v_garand_rg.mdl"
SWEP.WorldModel			= "models/weapons/w_garand_gren.mdl"
...
SWEP.IronSightsPos 		= Vector (-4.9645, -8.5511, 4.263)
SWEP.IronSightsAng 		= Vector (-6.4827, 0.3379, 3.2757)
SWEP.RunArmOffset 		= Vector (5.5247, 0, 3.9521)
SWEP.RunArmAngle 			= Vector (-18.7062, 29.7856, 0)
...
function SWEP:SecondaryAttack()
	...
	if (self.Owner:KeyDown(IN_USE)) then
		if (SERVER) then
			self.Owner:SelectWeapon("weapon_mad_dod_garand")
		end
