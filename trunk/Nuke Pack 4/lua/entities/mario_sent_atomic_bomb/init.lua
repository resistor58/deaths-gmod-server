...
self.Entity:SetModel( "models/marioragdoll/mario/mario4.mdl" ) 	
...
function ENT:SpawnFunction( ply, tr)
	...
	local ent = ents.Create( "mario_sent_atomic_bomb" )
		ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
...
function ENT:Think()
	if ( self.isarmed == 1 ) then
	    self:SetOverlayText( " BACK AWAY!!!! " )
	else
	    self:SetOverlayText( " I'm safe " )
	end
