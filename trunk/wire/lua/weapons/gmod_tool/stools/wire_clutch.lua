...
if CLIENT then
    language.Add( "Tool_wire_clutch_name", "Clutch Tool (Wire)" )
    language.Add( "Tool_wire_clutch_desc", "Control rotational friction between props" )
    language.Add( "Tool_wire_clutch_0", "Primary: Place/Select a clutch controller\nSecondary: Select an entity to apply the clutch to\nReload: Remove clutch from entity/deselect controller" )
    language.Add( "Tool_wire_clutch_1", "Right click on the second entity you want the clutch to apply to" )
