...
if (SERVER) then
	...
	language.Add( "Tool_wire_dhdd_name", "DHDD Tool (Wire)" )
	language.Add( "Tool_wire_dhdd_desc", "Spawns a dupeable hard drive gate for use with the wire system." )
	language.Add( "Tool_wire_dhdd_0", "Primary: Create DHDD." )
