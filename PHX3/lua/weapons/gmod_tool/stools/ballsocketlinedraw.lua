...
cleanup.Register("BallsocketLinedraw")
...
if CLIENT then
	language.Add("BallsocketLinedraw", "Ballsocket Linedraw" )
	language.Add("Tool_ballsocketlinedraw_name","Ballsocket Linedraw")
	language.Add("Tool_ballsocketlinedraw_desc", "The middle of the drawn segment will be the ballsocket." )
	language.Add("Tool_ballsocketlinedraw_0", "Left: Select the first prop.    Right: Clear ballsocket" )
	language.Add("Tool_ballsocketlinedraw_1", "Left: Select the second prop.    Right: Previous" )
	language.Add("Tool_ballsocketlinedraw_2", "Left: Draw the starting point of the segment.    Right: Previous" )
	language.Add("Tool_ballsocketlinedraw_3", "Left: Draw the ending point of the segment.    Right: Previous" )
	language.Add("Tool_ballsocketlinedraw_4", "Left: Validate.    Right: Previous" )
	
	language.Add("Tool_ballsocketlinedraw_force", "Force Limit" )
	language.Add("Tool_ballsocketlinedraw_torque", "Torque Limit" )
	-- language.Add("Tool_ballsocketlinedraw_friction", "Friction" )
	language.Add("Tool_ballsocketlinedraw_nocollide", "Nocollide" )
	
	language.Add("Undone_ballsocketlinedraw","Undone Ballsocket Linedraw")
	language.Add("Cleanup_BallsocketLinedraw","Ballsocket Linedraw")
	language.Add("Cleaned_BallsocketLinedraw","Cleaned up all Ballsocket Linedraw")
end
...
function TOOL:LeftClick(trace)
	...
	if ( curStage > 3 ) then
		...
		local LPos = Phys2:WorldToLocal( WPos3 + ( WPos4 - WPos3 ) * 0.5 )
		...
		undo.Create("BallsocketLinedraw")
...
function TOOL:Holster( trace )
	...
	local curStage = self:GetStage()
	if curStage > 3 and not self._Alerted then
...
function TOOL.BuildCPanel(panel)
	panel:AddControl("Header",{Text = "#Tool_ballsocketlinedraw_name", Description	= "#Tool_ballsocketlinedraw_desc"})
	panel:AddControl("Slider",{Label = "#Tool_ballsocketlinedraw_force",
								Description = "",
								Type = "Float",
								Min = 0,
								Max = 50000,
								Command = "ballsocketlinedraw_forcelimit" } )	
	panel:AddControl("Slider",{Label = "#Tool_ballsocketlinedraw_torque",
								Description = "",
								Type = "Float",
								Min = 0,
								Max = 50000,
								Command = "ballsocketlinedraw_torquelimit" } )				
end
