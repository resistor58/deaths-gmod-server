...
function ENT:Initialize()
	...
	timer.Simple(0.1,util.Effect,"effect_explosion_scaleable",effectdata)
	...
	timer.Simple(0.12,util.ScreenShake,self.Position, 15, 5, 0.6*self.EffectScale, 1200*self.BlastScale)
